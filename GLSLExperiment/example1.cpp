...
//ve den ngu
void tuDen() {
	h2_instance_hop = Translate(-0.6, -0.425, 0.1) * Translate(0.23, 0.5, -0.53);
	hinhKhoi(0.1, 0.15, 0.1);
}

void truDen() {
	h2_instance_hop = Translate(-0.6, -0.425 + 0.125, 0.1 ) * Translate(0.23, 0.5, -0.53);
	hinhKhoi(0.01,0.1, 0.01);
}

void longDen(GLfloat x, GLfloat y, GLfloat z) {
	setColor(vec4(1, 1, 1));
	mat4 instance = Scale(x, y, z);
	glUniformMatrix4fv(model_loc, 1, true, Translate(-0.6, -0.425 + 0.125 + 0.04, 0.1) * instance);
	//glUniformMatrix4fv(colors_loc, 1, true, Translate(ax / 255, ay / 255, az / 255));
	glDrawArrays(GL_TRIANGLES, firstpointchop, numpointschop);
}
...
//ve binh hoa
void tuBinh() {
	h2_instance_hop = Translate(0.6, -0.425, 0.6) * Translate(0.23, 0.5, -0.53);
	hinhKhoi(0.1, 0.15, 0.1);
}

void duoiBinh(GLfloat x, GLfloat y, GLfloat z) {
	setColor(vec4(1, 1, 1));
	mat4 instance = Scale(x, y, z);
	glUniformMatrix4fv(model_loc, 1, true, Translate(0.6, -0.425 + 0.095, 0.6)* RotateZ(180) * instance);
	//glUniformMatrix4fv(colors_loc, 1, true, Translate(ax / 255, ay / 255, az / 255));
	glDrawArrays(GL_TRIANGLES, firstpointchop, numpointschop);
}

void trenBinh(GLfloat x, GLfloat y, GLfloat z) {
	setColor(vec4(1, 1, 1));
	mat4 instance = Scale(x, y, z);
	glUniformMatrix4fv(model_loc, 1, true, Translate(0.6, -0.425 + 0.095 + 0.07, 0.6) * instance);
	//glUniformMatrix4fv(colors_loc, 1, true, Translate(ax / 255, ay / 255, az / 255));
	glDrawArrays(GL_TRIANGLES, firstpointchop, numpointschop);
}

void binhHoa() {
	setColor(vec4(0.7, 0.3, 0.3, 1.0));
	tuBinh();
	duoiBinh(0.07, 0.07, 0.07);
	trenBinh(0.07,0.07,0.07);
}
...
void xeTang() {
	h2_instance_hop = Translate(-0.52, 0.13, 0.53) * Translate(0.23, 0.5, -0.53);
	hinhKhoi(0.12, 0.03, 0.1);  //than xe
	setColor(vec4(0.6, 0.3, 0.5));
	h2_instance_hop = Translate(-0.52, 0.13, 0.53) * Translate(0.0, -0.025, -0.05) * Translate(0.23, 0.5, -0.53);
	hinhKhoi(0.16, 0.03, 0.02);  //banh xe trai
	h2_instance_hop = Translate(-0.52, 0.13, 0.53) * Translate(0.0, -0.025, 0.05) * Translate(0.23, 0.5, -0.53);
	hinhKhoi(0.16, 0.03, 0.02);  //banh xe phai
	h2_instance_hop = Translate(-0.52, 0.12, 0.53) * Translate(0.02, 0.04, 0.0) * Translate(0.23, 0.5, -0.53);
	hinhKhoi(0.06, 0.03, 0.06);  //tu diem
	h2_instance_hop = Translate(-0.52, 0.12, 0.53) * Translate(0.08, 0.04, 0.0) * Translate(0.23, 0.5, -0.53);
	hinhKhoi(0.1, 0.005, 0.005);  //nong phao
}
...
void cup(GLfloat x, GLfloat y, GLfloat z) {
	setColor(vec4(0.6, 0.3, 0.5));
	h2_instance_hop = Translate(0.06, -0.01 + 0.12, 0.0 + 0.52) * Translate(0.23, 0.5, -0.53);
	hinhKhoi(0.08, 0.02, 0.08); // day cup
	mat4 instance = Scale(x, y, z);
	glUniformMatrix4fv(model_loc, 1 ,true, Translate(0.06, 0.12, 0.52) * RotateZ(180) * instance);
	//glUniformMatrix4fv(colors_loc, 1, true, Translate(ax / 255, ay / 255, az / 255));
	glDrawArrays(GL_TRIANGLES, firstpointnon, numpointsnon);
}
